...
switch ($opcion) {
    ...
    case "3": //Crear perfil
        ...
        $valor_exito = $dbPerfiles->crearPerfil($txt_nombre_perfil, $txt_desc_perfil, $cmb_menu_inicio, $id_usuario, $menus_permisos);
        ?>
    ...
    case "4": //Editar perfil
        ...
        $valor_exito = $dbPerfiles->editarPerfil($hdd_id_perfil, $txt_nombre_perfil, $txt_desc_perfil, $cmb_menu_inicio, $cmb_activo, $id_usuario, $menus_permisos);
        ?>
        <input type="hidden" value="<?php echo $valor_exito; ?>" name="hdd_exito" id="hdd_exito" />
        <?php
    break;
