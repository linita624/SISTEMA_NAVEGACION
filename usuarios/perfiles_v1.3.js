...
function validar_crear_perfil() {
    $("#frm_perfiles").validate({
        ...
        submitHandler: function() {
            ...
            confirmarEdicion("¿Realmente desea crear nuevo perfil?", "crear_perfil();");
        },
    });
}
...
function crear_perfil() {
	...
	//llamarAjax("perfiles_ajax.php", params, "principal_perfiles_ok", "");
}
...
function validar_editar_perfil() {
    $("#frm_perfiles").validate({
        ...
        submitHandler: function() {
			...
			confirmarEdicion("¿Realmente desea guardar la edición?", "editar_perfil();");
...
function confirmarEdicion(titulo, funcion) {
    ...
    llamarAjax("perfiles_ajax.php", params, "ventanaModal", "mostrarVentana();");
}
